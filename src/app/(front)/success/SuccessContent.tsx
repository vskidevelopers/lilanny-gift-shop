    ...
    return (
        <div className="container px-4 py-16 max-w-2xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">
                Thank you for shopping with Li & Lanny Trends. Your order{" "}
                <span className="font-mono font-bold text-foreground">{orderId}</span> has been received.
            </p>
                ...
                <CardContent className="space-y-3 text-sm text-muted-foreground">
                    ...
                    <p>
                        ...
                        {fulfillment === "delivery"
                            ? "Our team will call or WhatsApp you shortly to confirm your location and discuss the delivery fee."
                            : "We will prepare your items for store pickup."}
                    </p>
                    <p>
                        3.{" "}
                        {payment === "pay_later"
                            ? "We will share the M-Pesa Paybill details with you during our follow-up call/message."
